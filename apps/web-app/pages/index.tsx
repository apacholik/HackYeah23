  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <Tabs.Root defaultValue="greeting">
        ...
        <Tabs.TabsContent value="api" className="flex">
          <Card.Root className="w-1/5">
            <Card.CardHeader>
